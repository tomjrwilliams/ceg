...
class norm_mid_pct_vec_kw(NamedTuple):
    type: str
    #
    vec: Ref.Vector_F64
    a: float
...
class norm_mid_pct_vec(norm_mid_pct_vec_kw, Node.Vector_F64):
    """
    >>> g = Graph.new()
    >>> from . import rand
    >>> _ = rand.rng(seed=0, reset=True)
    ...
    DEF: ClassVar[Defn] = define.node(Node.Vector_F64, norm_mid_pct_vec_kw)
    bind = define.bind_from_new(norm_mid_pct_vec_kw.new, norm_mid_pct_vec_kw.ref)
...
class norm_mid_vec_kw(NamedTuple):
    type: str
    #
    vec: Ref.Vector_F64
    a: float
...
class norm_mid_vec(norm_mid_vec_kw, Node.Vector_F64):
    """
    >>> g = Graph.new()
    >>> from . import rand
    >>> _ = rand.rng(seed=0, reset=True)
    ...
    DEF: ClassVar[Defn] = define.node(Node.Vector_F64, norm_mid_vec_kw)
    bind = define.bind_from_new(norm_mid_vec_kw.new, norm_mid_vec_kw.ref)
...
class norm_mid_inner_vec_kw(NamedTuple):
    type: str
    #
    vec: Ref.Vector_F64
    a: float
...
class norm_mid_inner_vec(norm_mid_vec_kw, Node.Vector_F64):
    """
    >>> g = Graph.new()
    >>> from . import rand
    >>> _ = rand.rng(seed=0, reset=True)
    ...
    DEF: ClassVar[Defn] = define.node(Node.Vector_F64, norm_mid_vec_kw)
    bind = define.bind_from_new(norm_mid_inner_vec_kw.new, norm_mid_inner_vec_kw.ref)
